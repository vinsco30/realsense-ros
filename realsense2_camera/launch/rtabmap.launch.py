...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frame_id',       default_value='T265_link',          description='Fixed frame id of the robot (base frame), you may set "base_link" or "base_footprint" if they are published. For camera-only config, this could be "camera_link".'),
        DeclareLaunchArgument('odom_frame_id',  default_value='T265_odom_frame',                   description='If set, TF is used to get odometry instead of the topic.'),
        ...
        DeclareLaunchArgument('queue_size',     default_value='200',                 description=''),
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/D400/color/image_raw',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/D400/depth/image_rect_raw', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/D400/color/camera_info',            description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/T265/odom/sample',  description='Odometry topic name.'),
